...
![PFC/ECN/DCQCN 三件套架构图](images/pfc-ecn-dcqcn-architecture.svg)
...
![PFC PAUSE 帧交互时序](images/pfc-pause-sequence.svg)
...
![ECN 标记与 CNP 返回流程](images/ecn-marking-flow.svg)
...
![DCQCN 状态机](images/dcqcn-state-machine.svg)
...
![缓冲区阈值分层示意图](images/buffer-threshold-hierarchy.svg)
